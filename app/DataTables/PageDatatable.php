...
class PageDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.pages.actions.checkbox')
            ->addColumn('edit', 'admin.pages.actions.edit')
            ->addColumn('delete', 'admin.pages.actions.delete')
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('admin.new_page'),
    ...
    protected function getColumns()
    {
        return [
            Column::computed('checkbox')
              ...
              ->printable(false),
            Column::make('id'),
            Column::make('name_en')->title(trans('admin.page_name_en')),
            Column::make('name_ar')->title(trans('admin.page_name_ar')),
            Column::make('slug')->title(trans('admin.page_slug')),
