...
class ColorDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.colors.actions.checkbox')
            ->addColumn('color', 'admin.colors.actions.color')
            ->addColumn('edit', 'admin.colors.actions.edit')
            ->addColumn('delete', 'admin.colors.actions.delete')
            ->addColumn('updated_at', 'admin.admins.actions.updated_at')
            ->addColumn('created_at', 'admin.admins.actions.created_at')
            ->rawColumns([
                'checkbox', 'color', 'edit', 'delete', 'updated_at', 'created_at'
            ]);
    }
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('admin.new_color'),
    ...
    protected function getColumns()
    {
        return [
            ...
            ->printable(false),
            Column::make('id'),
            Column::make('colors_name_ar')->title(trans('admin.colors_name_ar')),
            Column::make('colors_name_en')->title(trans('admin.colors_name_en')),
            Column::computed('color')
