...
class WeightDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.weights.actions.checkbox')
            ->addColumn('edit', 'admin.weights.actions.edit')
            ->addColumn('delete', 'admin.weights.actions.delete')
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('admin.new_weight'),
    ...
    protected function getColumns()
    {
        return [
            ...
            ->printable(false),
            Column::make('id'),
            Column::make('weights_name_ar')->title(trans('admin.weights_name_ar')),
            Column::make('weights_name_en')->title(trans('admin.weights_name_en')),
