...
class LinksDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.links.actions.checkbox')
            ->addColumn('edit', 'admin.links.actions.edit')
            ->addColumn('menu_id', 'admin.links.actions.menu_id')
            ->addColumn('parent', 'admin.links.actions.parent')
            ->addColumn('delete', 'admin.links.actions.delete')
            ->addColumn('updated_at', 'admin.admins.actions.updated_at')
            ->addColumn('created_at', 'admin.admins.actions.created_at')
            ->rawColumns([
                'checkbox', 'edit', 'menu_id', 'parent', 'delete', 'updated_at', 'created_at'
            ]);
    }
    ...
    {
        return $this->builder()
        ->setTableId('linkdatatable-table')
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('admin.new_link'),
    ...
    protected function getColumns()
    {
        return [
            Column::computed('checkbox')
              ...
              ->printable(false),
              Column::make('id'),
            Column::make('link_name_ar')->title(trans('admin.link_name_ar')),
            Column::make('link_name_en')->title(trans('admin.link_name_en')),
            Column::computed('menu_id')
