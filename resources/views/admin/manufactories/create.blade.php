...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        {!! Form::open(['route' => 'manufactory.store', 'method' => 'POST', 'files' => true]) !!}
            <input type="hidden" value="{{ $lat }}" id="lat" name="lat">
            <input type="hidden" value="{{ $lng }}" id="lng" name="lng">
            <div class="form-group">
                {{ Form::label('manufactories_name_ar', trans('admin.manufactories_name_ar')) }}
                {{ Form::text('manufactories_name_ar', old('manufactories_name_ar'), ['class' => 'form-control'] )}}
            </div>
            <div class="form-group">
                {{ Form::label('manufactories_name_en', trans('admin.manufactories_name_en')) }}
                {{ Form::text('manufactories_name_en', old('manufactories_name_en'), ['class' => 'form-control'] )}}
            </div>
            <div class="form-group">
            ...
            {{ Form::submit(trans('admin.new_manufactory'), ['class' => 'btn btn-primary'] )}}
        {!! Form::close() !!}
    </div>
    <!-- /.card-body -->
  </div>
