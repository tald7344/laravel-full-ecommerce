...
<script>
  $(document).ready(function () {
    $('#jstree').jstree({
      "core" : {
          'data' : {!! load_departements($size->department_id) !!}
      },
      "checkbox" : {
...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        {!! Form::open(['route' => ['size.update', $size->id], 'method' => 'POST']) !!}
            <div class="form-group">
                {{ Form::label('sizes_name_ar', trans('admin.sizes_name_ar')) }}
                {{ Form::text('sizes_name_ar', $size->sizes_name_ar, ['class' => 'form-control'] )}}
            </div>
            <div class="form-group">
                {{ Form::label('sizes_name_en', trans('admin.sizes_name_en')) }}
                {{ Form::text('sizes_name_en', $size->sizes_name_en, ['class' => 'form-control'] )}}
            </div>
            ...
            {{ Form::hidden('department_id', $size->department_id, ['class' => 'department_id_class']) }}
            <div class="form-group">
